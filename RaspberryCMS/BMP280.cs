...
{
    internal class BMP280_CalibrationData
    {
        //BMP280 Registers
    ...
    internal class BMP280
    {
        ...
        public async Task Initialize()
        {
            ...
            try
            {
                ...
                //Instantiate the the BMP280 I2C device using the device id of the I2CBus 
        ...
        //Method to take the sea level pressure in Hectopascals(hPa) as a parameter and 
        //calculate the altitude using current pressure.
